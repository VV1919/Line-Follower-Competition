...
class LineFollower:
    ...
    def __init__(self):
        ...
        self.robot = ROSRider('robot1', 20.0, self.process_image_and_steer)
    ...
    def process_image_and_steer(self, image):

        # this method is called each time an image arrives, it must have the same name, while initializing robot
