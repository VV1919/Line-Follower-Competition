...
class LineFollower:
    ...
    def __init__(self):
        ...
        rot_vel_min_max = 2.25
        self.last_rotation = -1
        self.rot_values = numpy.linspace(rot_vel_min_max,-rot_vel_min_max,32)
    ...
    def main(self):
        ...
        while self.robot.is_ok():
            ...
            if(avg_index_value == int(round(self.sensor_array_len/2)) - 1 or avg_index_value == int(round(self.sensor_array_len/2))):
